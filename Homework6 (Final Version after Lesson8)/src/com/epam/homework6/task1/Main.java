...
//        Arrays.sort(array);
        ...
        Arrays.sort(array, new MyComparatorColor());
...
//    }
    ...
    public static void generalAreaCalc(Shape[] array) {
        ...
        System.out.printf("%s%7.2f%n", "General area is ", result);
    }
    ...
    public static void areaCalcPerShape(Shape[] array, Class<?> cls) {
        ...
        System.out.printf("%s%s%s%7.2f%n", "General area of ", cls.getSimpleName(), "s: ", result);
    }
}
